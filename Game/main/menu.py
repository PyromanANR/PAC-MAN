...
def levels_menu():
    ...
    level2_button = Button(375, 500, 150, 50, 'Level 2', (255, 255, 255), '3', (170, 170, 170), (100, 100, 100))
    level1_button = Button(375, 430, 150, 50, 'Level 1', (255, 255, 255), '2', (170, 170, 170), (100, 100, 100))
...
def main_menu():
    ...
    main_background = pygame.image.load(image_path)
    # Створення об'єкта кнопки
    exit_button = Button(375, 500, 150, 50, 'Exit', (255, 255, 255), '0', (170, 170, 170), (100, 100, 100))
    levels_button = Button(375, 430, 150, 50, 'Start', (255, 255, 255), '1', (170, 170, 170), (100, 100, 100))
